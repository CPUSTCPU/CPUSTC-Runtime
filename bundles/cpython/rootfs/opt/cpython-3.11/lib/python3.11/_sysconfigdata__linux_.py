...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-gcc-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-gcc '
              '-shared',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-gcc',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -D_LARGEFILE_SOURCE '
 ...
 'CONFIG_ARGS': "'--target=loongarch32-buildroot-linux-gnu' "
                "'--host=loongarch32-buildroot-linux-gnu' "
                ...
                "'--with-libmpdec=system' '--with-expat=system' "
                "'--with-openssl=/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/loongarch32-buildroot-linux-gnu/sysroot/usr' "
                "'--disable-uuid' '--disable-ossaudiodev' "
                "'--without-ensurepip' '--without-cxx-main' "
                "'--with-build-python=/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/python3' "
                "'--with-system-ffi' '--disable-pydoc' "
                "'--disable-test-modules' '--disable-tk' '--disable-nis' "
                "'--disable-idle3' '--disable-pyc-build' "
                "'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=loongarch32-buildroot-linux-gnu' "
                "'target_alias=loongarch32-buildroot-linux-gnu' "
                "'PKG_CONFIG=/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/pkg-config' "
                "'CC=/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-gcc' "
                "'CFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE "
                "-D_FILE_OFFSET_BITS=64  -Os -g0 -D_FORTIFY_SOURCE=1' "
                "'LDFLAGS=' 'CPPFLAGS=-D_LARGEFILE_SOURCE "
                "-D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64' "
                "'CPP=/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-cpp'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2/lcov-report',
 ...
 'CPPFLAGS': '-I. -I./Include -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
             '-D_FILE_OFFSET_BITS=64',
 'CXX': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-g++',
 ...
 'DFLAGS': '',
 'DIRMODE': 755,
 'DISABLED_EXTENSIONS': 'ossaudiodev nis _tkinter _uuid _dbm',
 ...
 'FREEZE_MODULE': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/python3 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/python3 '
                            './Programs/_freeze_module.py',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'loongarch32-buildroot-linux-gnu',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-g++ '
                '-shared',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-gcc '
             '-shared',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBMPDEC_CFLAGS': '-DCONFIG_32=1 -DANSI=1 -Wsign-compare -DNDEBUG -g -fwrapv '
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-gcc',
 ...
 'MAINCC': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODULE_BINASCII_LDFLAGS': '-L/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/../loongarch32-buildroot-linux-gnu/sysroot/usr/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '',
 'MODULE_ZLIB_LDFLAGS': '-L/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/../loongarch32-buildroot-linux-gnu/sysroot/usr/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/loongarch32-buildroot-linux-gnu/sysroot/usr/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/loongarch32-buildroot-linux-gnu/sysroot/usr/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '',
 'MODULE__LZMA_LDFLAGS': '-L/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/../loongarch32-buildroot-linux-gnu/sysroot/usr/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/../loongarch32-buildroot-linux-gnu/sysroot/usr/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/loongarch32-buildroot-linux-gnu/sysroot/usr/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/loongarch32-buildroot-linux-gnu/sysroot/usr/lib  '
                        '-lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/loongarch32-buildroot-linux-gnu/sysroot/usr/include',
 'OPENSSL_LDFLAGS': '-L/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/loongarch32-buildroot-linux-gnu/sysroot/usr/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2/`cat '
                     'pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_ '
                     '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/python3',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/python3',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'READELF': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/loongarch32r-linux-gnusf-readelf',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2/`cat '
               'pybuilddir.txt`:)./Lib '
               ...
               '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/host/bin/python3',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2/`cat '
               'pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2',
 'abs_srcdir': '/mnt/newdisk/CPUSTCPU/.agent-artifacts/20260819-cpython-la32r/output/build/python3-3.11.2',
